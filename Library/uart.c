...
Purpose:  wait here until desired character is received
Input:    character you wait for
Returns:  none
**************************************************************************/
void wait_to_get(char ch)
{
	while(ch != (char) uart_getc() );
}
...
/*************************************************************************
 ...
 Input:	   name of string,terminator
 Returns:  none
 **************************************************************************/
int uart_gets( char * s,char terminator){
	int c;
	for (char *bp = s; *(bp -1) != terminator; ++bp) {
		while( ( c = uart_getc() ) & UART_NO_DATA);
//		if( ( c = uart_getc() ) & UART_NO_DATA )
//			return 0;
		*bp = (char) c;
	}
	return 0;
...
/*************************************************************************
Function: wait_to_get1()
Purpose:  wait here until desired character is received
Input:    character you wait for
Returns:  none
**************************************************************************/
void wait_to_get1(char ch)
{
	while(ch != (char) uart1_getc() );
}
...
/*************************************************************************
 ...
 Returns:  none
 **************************************************************************/
int uart1_gets( char * s, char terminator){
	int c;
	for (char *bp = s; *(bp -1) != terminator; ++bp) {
		while( ( c = uart1_getc() ) & UART_NO_DATA);
//		if( ( c = uart_getc() ) & UART_NO_DATA )
//			return 0;
		*bp = (char) c;
	}
